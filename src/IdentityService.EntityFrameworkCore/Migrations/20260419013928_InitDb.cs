        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    OtpSecret = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    AuthToken = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    AuthTokenExpiry = table.Column<DateTime>(type: "TEXT", nullable: true),
                    RefreshTokenHash = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
